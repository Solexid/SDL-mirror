...
static SDL_Scancode Android_Keycodes[] = {
	...
	SDL_SCANCODE_BUTTON_A, /* AKEYCODE_BUTTON_A */
    SDL_SCANCODE_BUTTON_B, /* AKEYCODE_BUTTON_B */
    SDL_SCANCODE_BUTTON_C, /* AKEYCODE_BUTTON_C */
    SDL_SCANCODE_BUTTON_X, /* AKEYCODE_BUTTON_X */
    SDL_SCANCODE_BUTTON_Y, /* AKEYCODE_BUTTON_Y */
    SDL_SCANCODE_BUTTON_Z, /* AKEYCODE_BUTTON_Z */
    SDL_SCANCODE_BUTTON_L1,/* AKEYCODE_BUTTON_L1 */
    SDL_SCANCODE_BUTTON_R1,/* AKEYCODE_BUTTON_R1 */
    SDL_SCANCODE_BUTTON_L2, /* AKEYCODE_BUTTON_L2 */
    SDL_SCANCODE_BUTTON_R2, /* AKEYCODE_BUTTON_R2 */
    SDL_SCANCODE_BUTTON_THUMBL, /* AKEYCODE_BUTTON_THUMBL */
    SDL_SCANCODE_BUTTON_THUMBR, /* AKEYCODE_BUTTON_THUMBR */
    SDL_SCANCODE_BUTTON_START, /* AKEYCODE_BUTTON_START */
    SDL_SCANCODE_BUTTON_SELECT, /* AKEYCODE_BUTTON_SELECT */
    SDL_SCANCODE_BUTTON_MODE, /* AKEYCODE_BUTTON_MODE */
